...
namespace CodeWalker.Export
{
    ...
    public static class CutsceneGltfExporter
    {
        ...
        // NOTE: BuildMergedBoneTracksDict has been moved to GltfWriter as the canonical
        // shared implementation, so single-ped (PedGltfExporter) and cutscene exports use
        // identical facial-expression resolution logic. Call GltfWriter.BuildMergedBoneTracksDict(ped).
